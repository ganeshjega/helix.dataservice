...
public class StateSasConverterThread extends ManagerThread {
	...
	public void process() {
		...
		while(cities.hasNext()) {
			...
			CitySasConverterThread citySasConverterThread = new CitySasConverterThread(city);
			citySasConverterThread.start();
			try {
				citySasConverterThread.join();
